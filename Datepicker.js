...
class Datepicker {
    constructor(options) {
        ...
        this.defaults = [];
        this.options.defaults[0] = this.options.defaults[0] !== undefined || !this.options.defaults[0] ? this.options.defaults[0] : moment(moment(), this.format, true);
        this.options.defaults[1] = this.options.defaults[1] !== undefined || !this.options.defaults[1] ? this.options.defaults[1] : moment(moment(), this.format, true);
